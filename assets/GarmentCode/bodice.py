...
class FittedShirtHalf(pyp.Component):
    ...
    def __init__(self, name, body_opt, design_opt) -> None:
        ...
        self.ftorso = BodiceFrontHalfSide(f'{name}_ftorso', body_opt, design_opt, 2).translate_by([0, 0, 20])
        self.btorso = BodiceBackHalfSide(f'{name}_btorso', body_opt, design_opt, 2).translate_by([0, 0, -20])
