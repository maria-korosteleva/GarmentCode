...
_REGISTERED_SLEEVE_CLS = {}
_REGISTERED_SLEEVE_CFG = {}
...
def get_config(name: str):
    ...
    cfg_creater = registry.lookup(_REGISTERED_SLEEVE_CFG, name)
    return cfg_creater()


def register_config(key: str):
    return registry.register(_REGISTERED_SLEEVE_CFG, key)
