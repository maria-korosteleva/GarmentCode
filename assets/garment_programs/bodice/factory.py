...
_REGISTERED_BODICE_CLS = {}
_REGISTERED_BODICE_CFG = {}
...
def get_config(name: str):
    ...
    cfg_creater = registry.lookup(_REGISTERED_BODICE_CFG, name)
    return cfg_creater()


def register_config(key: str):
    return registry.register(_REGISTERED_BODICE_CFG, key)
